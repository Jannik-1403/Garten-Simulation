...
enum GartenTierStufe: CaseIterable {
    ...
    func lokalisiertTitel(settings: SettingsStore) -> String {
        switch self {
        case .bronzeI:    return String(localized: "tier_stufe_bronze_1")
        case .bronzeII:   return String(localized: "tier_stufe_bronze_2")
        case .bronzeIII:  return String(localized: "tier_stufe_bronze_3")
        case .silberI:    return String(localized: "tier_stufe_silber_1")
        case .silberII:   return String(localized: "tier_stufe_silber_2")
        case .silberIII:  return String(localized: "tier_stufe_silber_3")
        case .goldI:      return String(localized: "tier_stufe_gold_1")
        case .goldII:     return String(localized: "tier_stufe_gold_2")
        case .goldIII:    return String(localized: "tier_stufe_gold_3")
        case .diamantI:   return String(localized: "tier_stufe_diamant_1")
        case .diamantII:  return String(localized: "tier_stufe_diamant_2")
        case .diamantIII: return String(localized: "tier_stufe_diamant_3")
        }
    }
