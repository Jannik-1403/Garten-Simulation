...
struct GameDatabase {
    ...
    static let allTrashItems: [DecorationItem] = [
        ...
        DecorationItem(id: "trash.fast_food_abo",         nameKey: "trash.fast_food_abo.name",         descriptionKey: "trash.fast_food_abo.desc",         sfSymbol: "drop.circle.fill",     price: 40,  category: .wasser),
        DecorationItem(id: "trash.endlos_scroll_tv",      nameKey: "trash.endlos_scroll_tv.name",      descriptionKey: "trash.endlos_scroll_tv.desc",      sfSymbol: "bird.fill",            price: 25,  category: .tiere),
        DecorationItem(id: "trash.luxus_auto",            nameKey: "trash.luxus_auto.name",            descriptionKey: "trash.luxus_auto.desc",            sfSymbol: "lightbulb.fill",       price: 20,  category: .beleuchtung),
        DecorationItem(id: "trash.party_pass",            nameKey: "trash.party_pass.name",            descriptionKey: "trash.party_pass.desc",            sfSymbol: "circle.grid.3x3.fill", price: 30,  category: .pfade),
        ...
        DecorationItem(id: "trash.online_shopping_app",   nameKey: "trash.online_shopping_app.name",   descriptionKey: "trash.online_shopping_app.desc",   sfSymbol: "shield.fill",           price: 50,  category: .wasser),
        DecorationItem(id: "trash.junk_mail_abo",         nameKey: "trash.junk_mail_abo.name",         descriptionKey: "trash.junk_mail_abo.desc",         sfSymbol: "drop.fill",            price: 18,  category: .wasser),
        ...
        DecorationItem(id: "trash.alkohol_flatrate",      nameKey: "trash.alkohol_flatrate.name",      descriptionKey: "trash.alkohol_flatrate.desc",      sfSymbol: "figure.stand",          price: 60,  category: .deko),
        DecorationItem(id: "trash.doomscrolling_handy",   nameKey: "trash.doomscrolling_handy.name",   descriptionKey: "trash.doomscrolling_handy.desc",   sfSymbol: "fanblades.fill",       price: 15,  category: .deko),
        ...
        DecorationItem(id: "trash.fastfood_lieferdienst", nameKey: "trash.fastfood_lieferdienst.name", descriptionKey: "trash.fastfood_lieferdienst.desc", sfSymbol: "flame.fill",           price: 15,  category: .beleuchtung),
        DecorationItem(id: "trash.lootbox_zockerabo",     nameKey: "trash.lootbox_zockerabo.name",     descriptionKey: "trash.lootbox_zockerabo.desc",     sfSymbol: "basket.fill",          price: 10,  category: .deko),
        DecorationItem(id: "trash.luxus_uhr",             nameKey: "trash.luxus_uhr.name",             descriptionKey: "trash.luxus_uhr.desc",             sfSymbol: "hexagon.fill",         price: 45,  category: .tiere),
        DecorationItem(id: "trash.couch_abo",             nameKey: "trash.couch_abo.name",             descriptionKey: "trash.couch_abo.desc",             sfSymbol: "leaf.arrow.triangle.circlepath", price: 20, category: .tiere),
        DecorationItem(id: "trash.doener_dauerkarte",     nameKey: "trash.doener_dauerkarte.name",     descriptionKey: "trash.doener_dauerkarte.desc",     sfSymbol: "cloud.fill",           price: 25,  category: .pfade),
        DecorationItem(id: "trash.negativitaets_feed",    nameKey: "trash.negativitaets_feed.name",    descriptionKey: "trash.negativitaets_feed.desc",    sfSymbol: "archway",               price: 80,  category: .pfade),
    ...
    static let allPowerUps: [PowerUpItem] = [
        ...
        PowerUpItem(id: "powerup.wunder_wasser",      name: "item.wunder_wasser.name",         symbolName: "Powerup-Wunderwasser",  symbolColor: "blue",   description: "item.wunder_wasser.description",                 unlockMethod: .levelUp,        rarity: .rare,      durationHours: 24.0,  effectMultiplier: 1.0, howToUse: "item.wunder_wasser.usage", target: .garden),
        PowerUpItem(id: "powerup.sturmfest",         name: "item.waechter_turm.name",          symbolName: "Powerup-WächterTurm",   symbolColor: "orange", description: "item.waechter_turm.description",unlockMethod: .streak14,       rarity: .rare,      durationHours: 24.0,  effectMultiplier: 1.0, howToUse: "item.waechter_turm.usage",   target: .garden),
