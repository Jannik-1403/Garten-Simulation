...
extension GartenPassBelohnung {
    static let alle: [GartenPassBelohnung] = [
        ...
        .init(id: 6,  typ: .coins(150),                         istMeilenstein: false),
        ...
        .init(id: 13, typ: .powerUp(id: "powerup.herz_auffueller"), istMeilenstein: false),
        ...
        .init(id: 21, typ: .coins(200),                         istMeilenstein: false),
        ...
        .init(id: 26, typ: .coins(200),                         istMeilenstein: false),
        .init(id: 27, typ: .gluecksradDrehung(2),               istMeilenstein: false),
        ...
        .init(id: 33, typ: .powerUp(id: "powerup.duenger_blitz"),istMeilenstein: false),
        ...
        .init(id: 41, typ: .coins(300),                         istMeilenstein: false),
        ...
        .init(id: 47, typ: .gluecksradDrehung(3),               istMeilenstein: false),
