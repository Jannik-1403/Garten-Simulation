...
class RunningProgressionStrategy: HabitProgressionStrategy {
    func generateProgression(dayNum: Int, difficulty: String) -> ProgressionData {
        ...
        case 1:
            ...
            todos = [String(localized: "prog_running_d1_t1", defaultValue: "\(formattedDist) km locker laufen"), String(localized: "prog_running_d1_t3", defaultValue: "Bewusst durch die Nase atmen")]
        case 2:
        ...
        case 4:
            ...
            let formattedDist = String(format: "%.1f", dist)
            todos = [String(localized: "prog_running_d4_t1", defaultValue: "\(formattedDist) km im zügigen Tempo")]
        case 5:
        ...
        case 6:
            ...
            let formattedDist = String(format: "%.1f", dist)
            todos = [String(localized: "prog_running_d6_t1", defaultValue: "\(formattedDist) km absolviert"), String(localized: "prog_running_d6_t3", defaultValue: "Tempo bewusst niedrig gehalten")]
        case 7:
