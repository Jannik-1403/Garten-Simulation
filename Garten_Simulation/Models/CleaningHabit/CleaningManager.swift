...
class CleaningManager: ObservableObject {
    ...
    func addTask(nameKey: String, iconName: String, frequencyDays: Int, scheduledWeekday: Int?, colorHex: String = "gruenPrimary", startDate: Date = Date()) {
        let newTask = CleaningTask(nameKey: nameKey, iconName: iconName, frequencyDays: frequencyDays, createdAt: startDate, scheduledWeekday: scheduledWeekday, colorHex: colorHex)
