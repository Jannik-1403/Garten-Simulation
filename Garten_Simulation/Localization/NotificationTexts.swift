...
struct NotificationTexts {
    ...
    private static func deErinnerung(pflanzenName: String, variant: Int) -> (title: String, body: String) {
        ...
        case 4:
            return ("⭐️ Streakgefahr!", "Nicht vergessen: \(pflanzenName) wartet noch. Gieße jetzt und sichere deinen Streak!")
        default:
    ...
    private static func enErinnerung(pflanzenName: String, variant: Int) -> (title: String, body: String) {
        ...
        case 4:
            return ("⭐️ Streak alert!", "Don't forget: \(pflanzenName) is waiting. Water now and protect your streak!")
        default:
    ...
    private static func esErinnerung(pflanzenName: String, variant: Int) -> (title: String, body: String) {
        ...
        case 4:
            return ("⭐️ ¡Alerta de racha!", "No olvides: \(pflanzenName) espera. ¡Riega ahora y protege tu racha!")
        default:
    ...
    private static func frErinnerung(pflanzenName: String, variant: Int) -> (title: String, body: String) {
        ...
        case 4:
            return ("⭐️ Alerte série !", "N'oublie pas : \(pflanzenName) attend. Arrose maintenant et protège ta série !")
        default:
    ...
    private static func itErinnerung(pflanzenName: String, variant: Int) -> (title: String, body: String) {
        ...
        case 4:
            return ("⭐️ Allerta serie!", "Non dimenticare: \(pflanzenName) aspetta. Innaffia ora e proteggi la tua serie!")
        default:
    ...
    private static func ptErinnerung(pflanzenName: String, variant: Int) -> (title: String, body: String) {
        ...
        case 4:
            return ("⭐️ Alerta de sequência!", "Não esqueças: \(pflanzenName) espera. Rega agora e protege a tua sequência!")
        default:
