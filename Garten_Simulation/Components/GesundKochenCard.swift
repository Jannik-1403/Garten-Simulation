            ...
            if healthManager.isAuthorized {
                if !hasSetGoals {
                    VStack(spacing: 12) {
                        ...
                        Text(String(localized: "habit.cook.setup_desc", defaultValue: "Gib dein Kalorienziel ein, bevor die Statistiken berechnet und angezeigt werden."))
                            .font(.subheadline)
                        ...
                        Item3DButton(
                            ...
                            HStack {
                                ...
                                Text(String(localized: "habit.cook.setup_btn", defaultValue: "Ziel eingeben"))
                            }
                            .font(.headline)
