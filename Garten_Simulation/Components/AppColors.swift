...
extension Color {
    ...
    static let gewoehnlichPrimary = Color(red: 0.56, green: 0.56, blue: 0.58)
    static let gewoehnlichSecondary = Color(red: 0.40, green: 0.40, blue: 0.42)
    
    static let seltenPrimary = Color(red: 0.0, green: 0.48, blue: 1.0)
    static let seltenSecondary = Color(red: 0.0, green: 0.32, blue: 0.78)
    
    static let epischPrimary = Color(red: 0.69, green: 0.32, blue: 0.87)
    static let epischSecondary = Color(red: 0.50, green: 0.15, blue: 0.68)
