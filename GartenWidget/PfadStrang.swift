...
class PfadStrang {
    ...
    var pflanzenID: String          // Welche Pflanze gehört zu diesem Strang (Habit-Instanz-ID)
    var plantTypeID: String = ""         // Die ID der Pflanzenart für Lokalisierung (z.B. plant.strawberry)
