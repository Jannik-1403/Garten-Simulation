...
public enum PflanzenStufe: Int, CaseIterable, Codable {
    case bronze1 = 0
    case bronze2 = 1
    case bronze3 = 2
    case silber1 = 3
    ...
    public var rarity: PflanzenSeltenheit {
        switch self {
    ...
    public static func stufe(fuerXP xp: Int) -> PflanzenStufe {
