...
struct GameDatabase {
    ...
    static let allPowerUps: [PowerUpItem] = [
        ...
        PowerUpItem(id: "powerup.zauberstab",        name: "item.zauberstab.name",            symbolName: "Powerup-Zauberstarb",    symbolColor: "indigo", description: "item.zauberstab.description",                   unlockMethod: .levelUp,        rarity: .rare,      durationHours: 72.0,  effectMultiplier: 1.0, howToUse: "item.zauberstab.usage",     target: .garden),
