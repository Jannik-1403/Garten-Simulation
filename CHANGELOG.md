## 2026-07-16
- **Bugfix**: Der 90-Tage Challenge Balken bei den Pflanzen (Gartenseite) ist nun mit dem tatsächlichen Fortschritt auf dem Pfad (dem gerade aktiven Tag) synchronisiert, anstatt fälschlicherweise den Gieß-Streak oder starr Tag 1 anzuzeigen.
...
- **Screen Time Core Fix 3**: Die permanenten Blocks (immer gesperrte Apps) wurden gefixt. Nach einer Neuinstallation oder dem manuellen Aktivieren der Rechte in den iOS-Einstellungen wurden sie bisher manchmal nicht geladen. Die App hört jetzt auf iOS-Foreground-Events und wendet die Limits immer zuverlässig an.
...
- Changed CoinPackCard layout so 'Coins' appears below the amount
