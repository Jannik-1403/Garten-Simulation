...
- **Pro Bonus Visualisierung**: Wenn eine Pflanze gegossen wird, wird nun standardmäßig ein kleines 3D-Popup direkt über der Pflanze angezeigt, das die erhaltenen XP und Münzen visualisiert. Für Pro-Nutzer wird hier zusätzlich auffällig **"(PRO BONUS)"** eingeblendet, um den permanenten 25% Boost auf XP und Coins sichtbar zu machen.
